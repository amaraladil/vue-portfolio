  ...
  >
    ...
    >
      <div class="techstack order-first md:order-2">
        <v-icon
          v-if="project.icons"
          v-for="code in project.icons"
          :title="code.substring(3)"
          :name="code"
      ...
      <div class="flex order-3">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          class="text-gray-200 bg-indigo-900 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg px-4 py-2 text-center inline-flex items-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-blue-800 font-bold"
        >
          <v-icon name="si-github" />
          Source
          <svg
            class="rtl:rotate-180 w-3.5 h-3.5 ms-2 mx-1"
            aria-hidden="true"
